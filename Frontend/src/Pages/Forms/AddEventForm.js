            ...
            <Col>
              <Card>
                <CardBody>
                  ...
                  {/* <Row className="mb-3">
                    <label className="col-md-2 col-form-label">Choose the Department:</label>
                    <div className="col-md-10">
                      <select className="form-control">
                        <option>Select</option>
                        <option>CSE & IT</option>
                        <option>ECE</option>
                        <option>AIML,IOT & DS</option>
                  ...
                  <Row className="mb-3">
                    ...
                    <div className="col-md-10">
                      <input
                        className="form-control"
                        type="text"
                        placeholder="Enter the amount to be paid for the Entry"
                      />
                    </div>
                  </Row>
                  <Row className="mb-3">
                  ...
                  <Row className="mb-3">
                    ...
                    <div className="col-md-10">
                      <input
                        className="form-control"
                        type="datetime-local"
                        placeholder="2019-08-19T13:45:00"
                  ...
                  <Row>
                    ...
                    <div className="col-md-10">
                      ...
                      <datalist id="datalistOptions">
                        <option placeholder="San Francisco" />
                        <option placeholder="New York" />
                        <option placeholder="Seattle" />
                        <option placeholder="Los Angeles" />
                        <option placeholder="Chicago" />
                      </datalist>
                    </div>
                  </Row>
                </CardBody>
