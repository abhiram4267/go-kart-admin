          ...
          <div className="d-flex">
            <div className="navbar-brand-box text-center">
              <Link to="/" className="logo logo-dark">
                <span className="logo-sm" style={{fontSize: '30px', fontWeight: 'bold', color: 'gold'}}>COLORS'2k25</span>
                <span className="logo-lg" style={{fontSize: '30px', fontWeight: 'bold', color: 'goldenrod'}}>COLORS'2k25</span>
              </Link>

              <Link to="/" className="logo logo-light">
                <span className="logo-sm" style={{fontSize: '30px', fontWeight: 'bold', color: 'gold'}}>COLORS'2k25</span>
                <span className="logo-lg" style={{fontSize: '30px', fontWeight: 'bold', color: 'gold'}}>COLORS'2k25</span>
              </Link>
              {/* <Link to="/" className="logo logo-dark">
